...
% Figure 2.A.
% This script runs a Principal Component Analysis on the proteomic database
...
hold on;
title('Principal Component Analysis: Proteins by Gut Location');
