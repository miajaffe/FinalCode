...
% Hierarchical Clustering of 77 proteins

% Figure S6
% This script runs a Hierarchical Clustering Analysis on 77 proteins 
% and generations a clustergram.
...
load('../Initialization/mia_clustering_work_with_final_norm.mat');
...
%         0    0.0013    0.0095    0.0271    0.0548


%percentages2 =

%    0.0134    0.0145    0.0155    0.0167    0.0182
...
plot(clustergram(all_samples, 'ColumnLabels', all_labels', 'DisplayRange', 0.0271, 'Symmetric', 'true', 'Colormap', winter));

print -dpdf -r600 Figure_S6.pdf
